...
import {faFacebook, faTwitter, faInstagram, faGoogle, faSquareFacebook} from "@fortawesome/free-brands-svg-icons"
                    ...
                    <div className="col-md-6 col-lg-6">
                        <div className="text-center">
                            <ul className="list-unstyled d-inline-flex gap-4 social-icon-list">
                                <li>
                                    <Link to="#"  className="d-inline-flex align-items-center justify-content-center rounded-circle" style={{width: '36px', height: '36px'}}>
                                        <FontAwesomeIcon icon={faFacebook}  className="text-light" style={{ fontSize: '24px'}}/>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="#"  className="d-inline-flex align-items-center justify-content-center rounded-circle" style={{width: '36px', height: '36px'}}>
                                        <FontAwesomeIcon icon={faInstagram}  className="text-light" style={{fontSize: '24px'}}/>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="#"  className="d-inline-flex align-items-center justify-content-center rounded-circle" style={{width: '36px', height: '36px'}}>
                                        <FontAwesomeIcon icon={faTwitter}  className="text-light" style={{fontSize: '24px'}}/>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="#" className="d-inline-flex align-items-center justify-content-center rounded-circle" style={{width: '36px', height: '36px'}}>
                                        <FontAwesomeIcon icon={faGoogle} className="text-light" style={{fontSize: '24px'}}/>
                                    </Link>
                                </li>
                            </ul>
                        </div>
