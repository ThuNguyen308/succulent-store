...
export const createProductController = async (req, res) => {
    try {
        // console.log(req.fields, req.files, '--pro')
...
export const updateProductController = async (req, res) => {
    try {
        ...
        // const product = new productModel({...req.fields, slug: slugify(name)})
        const product = await productModel.findByIdAndUpdate(req.params.pid.trim(), 
...
export const productFiltersController = async (req, res) => {
    try {
        ...
        if(radioPrice.length) args.price = {$gte: radioPrice[0], $lte: radioPrice[1]}
...
export const productCategoryController = async (req, res) => {
    try {
        console.log(req.params.slug, '-----controllre')
